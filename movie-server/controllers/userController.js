...
//  For signUp : createUser, verifyUser.
// For login : login. 
...
// username is verified at backend whether it is already taken or not when client tries to signUp using new username.
...
// Checking For User authentication when client Tries to Login using username & Password. 
login = async (req, res) => {
  const body = req.body;
